        ...
        <div className="page-bg" style={{ minHeight: '100vh', paddingBottom: 80 }}>
            ...
            <div className="container-js" style={{ paddingTop: 32 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 20, marginBottom: 40 }}>
                    {profiles.education && (
                        <div className="card-js" style={{ padding: 20, borderTop: '4px solid #8b5cf6' }}>
                    ...
                    {profiles.healthcare && (
                        <div className="card-js" style={{ padding: 20, borderTop: '4px solid #10b981' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
                                <span style={{ fontSize: 24 }}>🏥</span>
                    ...
                    {profiles.agriculture && (
                        <div className="card-js" style={{ padding: 20, borderTop: '4px solid #f59e0b' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
                                <span style={{ fontSize: 24 }}>🌾</span>
