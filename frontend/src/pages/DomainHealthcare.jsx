                    ...
                    <div>
                        ...
                        <div className="card-js" style={{ padding: 24, marginTop: 24 }}>
                            ...
                            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                                <li style={{ padding: '12px 0', borderBottom: '1px solid var(--border-light)', cursor: 'pointer', color: selectedService === 'scheme' ? 'var(--accent)' : 'var(--text-primary)' }} onClick={() => setSelectedService('scheme')}>
                                    🏥 Ayushman Bharat Registration
                                </li>
                                <li style={{ padding: '12px 0', borderBottom: '1px solid var(--border-light)', cursor: 'pointer', color: selectedService === 'appointment' ? 'var(--accent)' : 'var(--text-primary)' }} onClick={() => setSelectedService('appointment')}>
                                    👨‍⚕️ Book OPD Appointment
                                </li>
                                <li style={{ padding: '12px 0', cursor: 'pointer' }} onClick={() => setSelectedService('insurance')}>
                    ...
                    <div>
                        {!selectedService ? (
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: 20 }}>
                                ...
                                <div 
                                    onClick={() => navigate('/healthcare/apply')}
                                    style={{
